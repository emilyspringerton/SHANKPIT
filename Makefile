...
# ---- Sources ----
LOBBY_SRC    := apps/lobby/src/main.c packages/simulation/story_ai.c packages/simulation/cutscene.c packages/simulation/typing_lesson.c packages/render/proc_tex.c packages/render/retro_material.c packages/render/retro_sky.c packages/render/retro_lighting.c packages/render/gl_shader.c packages/world/terrain.c packages/world/parena_runtime.c packages/world/png_decode_gen.c packages/audio/audio.c packages/goldenband/gband.c packages/goldenband/gskel.c packages/goldenband/gmesh.c packages/goldenband/gband_mesh_rig.c
